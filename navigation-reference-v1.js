...
(() => {
      ...
      <main id="oauthConsentRoot" style="min-height:100vh;display:grid;place-items:center;padding:24px;background:#f4f6f8;font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#15191d">
        <section style="width:min(520px,100%);background:#fff;border:1px solid #e3e8eb;border-radius:22px;box-shadow:0 18px 60px rgba(25,32,38,.08);padding:30px">
          <div style="display:flex;align-items:center;gap:13px;margin-bottom:24px">
            <img src="/api/brand-icon?v=20260922-1" alt="AllianceOS" style="width:46px;height:46px;display:block;object-fit:contain">
  ...
  function setup(){
    ...
    head.innerHTML='<div class="ref2-sidebar-logo"><img src="/api/brand-icon?v=20260922-1" alt="" aria-hidden="true"></div><div class="ref2-sidebar-name">AllianceOS</div>';
    ...
    topLogo.innerHTML='<div class="ref2-top-logo-icon"><img src="/api/brand-icon?v=20260922-1" alt="" aria-hidden="true"></div><div class="ref2-top-logo-name">AllianceOS</div>';
