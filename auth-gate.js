    ...
    return ''+
      '<div class="showcase-device">'+
        '<aside class="preview-sidebar">'+
          '<div class="preview-logo"><span><img src="/api/brand-icon?v=20260922-1" alt="" aria-hidden="true"></span><strong>AllianceOS</strong></div>'+
      ...
      '<main class="auth-stage">'+
        '<div class="auth-frame">'+
          '<section class="auth-panel">'+
            '<div class="auth-wordmark"><span class="auth-mark"><img src="/api/brand-icon?v=20260922-1" alt="" aria-hidden="true"></span><strong>AllianceOS</strong></div>'+
  ...
  function renderPending(profile){
    ...
    root().innerHTML=''+
      '<main class="auth-stage"><div class="auth-frame">'+
        '<section class="auth-panel"><div class="auth-wordmark"><span class="auth-mark"><img src="/api/brand-icon?v=20260922-1" alt="" aria-hidden="true"></span><strong>AllianceOS</strong></div>'+
