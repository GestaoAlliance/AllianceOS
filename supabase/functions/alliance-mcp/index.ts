...
const MCP_BRAND_VERSION = '20260921-2'
const MCP_ICON_B64 = ''
const MCP_ICON_DATA_URI = 'data:image/png;base64,' + MCP_ICON_B64
const MCP_ICON_URL = 'https://lpnyrzsdiyzjnhovpduk.supabase.co/functions/v1/alliance-mcp/icon.png?v=' + MCP_BRAND_VERSION
...
function registerFullSystemTools(server:any,supabase:any){
  ...
  server.registerTool('atualizar_mes',{description:'Atualiza ou arquiva mês com histórico campo a campo.',inputSchema:z.object({id:z.string().uuid(),meta1:z.number().min(0).optional(),meta2:z.number().min(0).optional(),meta3:z.number().min(0).optional(),meta_ativa:z.number().int().min(1).max(3).optional(),ticket_medio_previsto:z.number().min(0).optional(),arquivado:z.boolean().optional()})},async(a:any)=>{const who=await actor(supabase);const{data:old,error:e}=await supabase.from('planning_months').select('*').eq('id',a.id).maybeSingle();if(e||!old)throw new Error('Mês não encontrado.');const p:any={atualizado_por:who.id};for(const k of ['meta1','meta2','meta3','meta_ativa','ticket_medio_previsto'])if(a[k]!==undefined)p[k]=a[k];if(a.arquivado!==undefined){p.arquivado_em=a.arquivado?(old.arquivado_em||nowIso()):null;p.arquivado_por=a.arquivado?who.id:null}const{data,error}=await supabase.from('planning_months').update(p).eq('id',a.id).select('*').single();if(error)throw new Error(error.message);const changes=fieldChanges(old,data,[['meta1','meta1'],['meta2','meta2'],['meta3','meta3'],['meta_ativa','meta_ativa'],['ticket_medio_previsto','ticket_medio_previsto'],['arquivado_em','arquivamento']]);await audit(supabase,who,'atualizar_mes','mes',a.id,changeAuditDetails(changes));return toolText({mes:await fullMonthPayload(supabase,data)})})
  ...
  server.registerTool('definir_tap',{
    ...
    const who=await actor(supabase),rows=await fullCampaigns(supabase),c=fullCampaign(rows,a.campanha_id),beforeTap=structuredClone(c.tapStructured??null),tap:any=structuredClone(a.tap)
  ...
  server.registerTool('atualizar_secao_tap',{
    ...
    const who=await actor(supabase),rows=await fullCampaigns(supabase),c=fullCampaign(rows,a.campanha_id),base=fullLegacyTap(c),section=a.secao==='metas_por_canal'?'metas_por_fonte':a.secao,beforeSection=structuredClone((base as any)[section]??null)
    let parsed:any
  ...
  server.registerTool('atualizar_mapa',{description:'Atualiza ou arquiva o mapa; nunca exclui. Histórico registra antes/depois.',inputSchema:z.object({id:z.string().uuid(),nome:z.string().min(1).optional(),layout:z.string().optional(),arquivado:z.boolean().optional()})},async(a:any)=>{const who=await actor(supabase),old=await fullMap(supabase,a.id),p:any={atualizado_por:who.id};if(a.nome!==undefined)p.nome=a.nome;if(a.layout!==undefined)p.layout=a.layout;if(a.arquivado!==undefined){p.arquivado_em=a.arquivado?(old.arquivado_em||nowIso()):null;p.arquivado_por=a.arquivado?who.id:null}const{data,error}=await supabase.from('planning_maps').update(p).eq('id',a.id).select('*').single();if(error)throw new Error(error.message);const changes=fieldChanges(old,data,[['nome','nome'],['layout','layout'],['arquivado_em','arquivamento']]);await fullSyncMap(supabase,data);await audit(supabase,who,'atualizar_mapa','mapa',a.id,changeAuditDetails(changes));return toolText({mapa:{...(await fullMapPayload(supabase,data)),historico:await fullAuditHistory(supabase,'mapa',a.id)}})})
  ...
  server.registerTool('atualizar_entrega',{
    ...
    const t=tasks.find((x:any)=>String(x.id)===String(d.sourceTaskId)),before=structuredClone(d),changes:string[]=[]
    ...
    d.updatedAt=nowIso();d.events=Array.isArray(d.events)?d.events:[];const deliveryChanges=fieldChanges(before,d,[['title','título'],['note','mensagem'],['to','destinatário'],['campaignId','campanha'],['targetTaskId','próxima tarefa'],['links','links'],['archivedAt','arquivamento']]);for(const ch of deliveryChanges)d.events.push({at:d.updatedAt,by:who.nome,authorId:who.id,origin:'mcp',campo:ch.campo,antes:ch.antes,depois:ch.depois,text:ch.campo+': '+historyDisplay(ch.antes)+' → '+historyDisplay(ch.depois)+'.'})
    if(t){
      ...
      t.history=Array.isArray(t.history)?t.history:[];for(const ch of [...deliveryChanges].reverse())t.history.unshift({at:d.updatedAt,by:who.nome,authorId:who.id,origin:'mcp',campo:'entrega.'+ch.campo,antes:ch.antes,depois:ch.depois,text:'entrega.'+ch.campo+': '+historyDisplay(ch.antes)+' → '+historyDisplay(ch.depois)+'.'})
      await writeTasks(supabase,tasks)
    }
    await fullSaveDeliveries(supabase,ds);await audit(supabase,who,'atualizar_entrega','entrega',String(d.id),changeAuditDetails(deliveryChanges,{tarefa_id:d.sourceTaskId||null,arquivada:!!d.archivedAt,campanha_id:hasOwn(d,'campaignId')?d.campaignId:null}))
  ...
  server.registerTool('aprovar_ou_reprovar_entrega',{
    ...
    const who=await actor(supabase),ds=await fullDeliveries(supabase),d=ds.find((x:any)=>String(x.id)===String(a.id));if(!d)throw new Error('Entrega não encontrada.');if(d.archivedAt)throw new Error('A entrega está arquivada. Desarquive antes de aprovar ou reprovar.');const before=structuredClone(d)
    d.status=a.decisao==='aprovar'?'aprovado':'ajustes';d.updatedAt=nowIso();if(a.decisao==='reprovar')d.adjustmentNote=a.comentario;const deliveryChanges=fieldChanges(before,d,[['status','status'],['adjustmentNote','comentário_ajuste']]);d.events=Array.isArray(d.events)?d.events:[];for(const ch of deliveryChanges)d.events.push({at:d.updatedAt,by:who.nome,authorId:who.id,origin:'mcp',campo:ch.campo,antes:ch.antes,depois:ch.depois,text:ch.campo+': '+historyDisplay(ch.antes)+' → '+historyDisplay(ch.depois)+'.'})
    ...
    await fullSaveDeliveries(supabase,ds);await audit(supabase,who,'aprovar_ou_reprovar_entrega','entrega',d.id,changeAuditDetails(deliveryChanges,{decisao:a.decisao,tarefa_id:d.sourceTaskId||null}));return toolText({entrega:{id:d.id,link:fullLinks('entrega',d.id),status:d.status,comentario:a.comentario}})
  })
  ...
  server.registerTool('atualizar_automacao',{description:'Atualiza/arquiva automação e valida gatilho/ação.',inputSchema:z.object({id:z.string().uuid(),nome:z.string().optional(),marca:z.string().optional(),gatilho:z.record(z.string(),z.any()).optional(),acao:z.record(z.string(),z.any()).optional(),canal:z.enum(['WhatsApp','e-mail','API']).optional(),status:z.enum(['ativa','pausada']).optional(),ultima_execucao:dt.nullable().optional(),arquivada:z.boolean().optional()})},async(a:any)=>{
    ...
    const{data,error}=await supabase.from('alliance_automations').update(p).eq('id',a.id).select('*').single();if(error)throw new Error(error.message);const changes=fieldChanges(old,data,[['nome','nome'],['brand_id','marca'],['gatilho','gatilho'],['acao','ação'],['canal','canal'],['status','status'],['ultima_execucao','última_execução'],['arquivado_em','arquivamento']]);await audit(supabase,who,'atualizar_automacao','automacao',a.id,changeAuditDetails(changes));return toolText({automacao:{...data,id:String(data.id),link:fullLinks('automacao',String(data.id)),historico:await fullAuditHistory(supabase,'automacao',a.id)}})
  })
  server.registerTool('ativar_ou_pausar_automacao',{description:'Pausa automação; ativação exige configuração válida e runtime executável.',inputSchema:z.object({id:z.string().uuid(),status:z.enum(['ativa','pausada'])})},async(a:any)=>{
    ...
    const{data,error}=await supabase.from('alliance_automations').update({status:a.status,atualizado_por:who.id}).eq('id',a.id).is('arquivado_em',null).select('*').maybeSingle();if(error||!data)throw new Error('Automação não encontrada.');const changes=fieldChanges(old,data,[['status','status']]);await audit(supabase,who,'ativar_ou_pausar_automacao','automacao',a.id,changeAuditDetails(changes));return toolText({automacao:{id:String(data.id),link:fullLinks('automacao',String(data.id)),status:data.status,historico:await fullAuditHistory(supabase,'automacao',a.id)}})
  })
  ...
  server.registerTool('registrar_resultado',{
    ...
    const{data:old}=await q.maybeSingle(),payload:any={canal,fonte_receita:fonte,faturamento:a.faturamento,investimento:a.investimento,observacoes:a.observacoes||null,atualizado_por:who.id,origem:'mcp'};let row:any,error:any,changes:any[]=[]
    if(old){const preview={...old,...payload};changes=fieldChanges(old,preview,[['canal','canal'],['fonte_receita','fonte_receita'],['faturamento','faturamento'],['investimento','investimento'],['observacoes','observações']]);const events=changes.map(ch=>({at,by:who.nome,authorId:who.id,origin:'mcp',campo:ch.campo,antes:ch.antes,depois:ch.depois,text:ch.campo+': '+historyDisplay(ch.antes)+' → '+historyDisplay(ch.depois)+'.'}));({data:row,error}=await supabase.from('campaign_results').update({...payload,historico:[...events,...(Array.isArray(old.historico)?old.historico:[])]}).eq('id',old.id).select('*').single())}
    else{const event={at,by:who.nome,authorId:who.id,origin:'mcp',campo:'criação',antes:null,depois:{canal,fonte_receita:fonte,faturamento:a.faturamento,investimento:a.investimento},text:'Resultado criado.'};({data:row,error}=await supabase.from('campaign_results').insert({...payload,campaign_id:String(c.id),brand_id:b.id,data:a.data,criado_por:who.id,historico:[event]}).select('*').single())}
    if(error)throw new Error(error.message);await audit(supabase,who,'registrar_resultado','resultado',row.id,changeAuditDetails(changes,{campanha_id:c.id,canal,fonte_receita:fonte}));return toolText({resultado:fullResultPublic(row)})
  })
  ...
  server.registerTool('atualizar_resultado',{
    ...
    const preview={...old,...patch},fieldDiffs=fieldChanges(old,preview,[['data','data'],['canal','canal'],['fonte_receita','fonte_receita'],['faturamento','faturamento'],['investimento','investimento'],['observacoes','observações'],['arquivado_em','arquivamento']]);const events=fieldDiffs.map(ch=>({at:nowIso(),by:who.nome,authorId:who.id,origin:'mcp',campo:ch.campo,antes:ch.antes,depois:ch.depois,text:ch.campo+': '+historyDisplay(ch.antes)+' → '+historyDisplay(ch.depois)+'.'}));patch.historico=[...events,...(Array.isArray(old.historico)?old.historico:[])]
    const{data,error}=await supabase.from('campaign_results').update(patch).eq('id',a.id).select('*').single();if(error)throw new Error(error.message);await audit(supabase,who,'atualizar_resultado','resultado',a.id,changeAuditDetails(fieldDiffs,{arquivado:!!data.arquivado_em}));return toolText({resultado:fullResultPublic(data)})
  })
  ...
  server.registerTool('atualizar_tag',{description:'Atualiza, arquiva ou desarquiva tag; nunca exclui. Histórico registra antes/depois.',inputSchema:z.object({id:z.string().uuid(),nome:z.string().min(1).optional(),cor:z.string().nullable().optional(),marca:z.string().nullable().optional(),arquivada:z.boolean().optional()})},async(a:any)=>{const who=await actor(supabase),{data:old}=await supabase.from('alliance_tags').select('*').eq('id',a.id).maybeSingle();if(!old)throw new Error('Tag não encontrada.');const p:any={atualizado_por:who.id};if(a.nome!==undefined)p.nome=a.nome;if(a.cor!==undefined)p.cor=a.cor;if(a.marca!==undefined)p.brand_id=a.marca?(await fullBrand(supabase,a.marca)).id:null;if(a.arquivada!==undefined){p.arquivado_em=a.arquivada?(old.arquivado_em||nowIso()):null;p.arquivado_por=a.arquivada?who.id:null}const{data,error}=await supabase.from('alliance_tags').update(p).eq('id',a.id).select('*').single();if(error)throw new Error(error.message);const changes=fieldChanges(old,data,[['nome','nome'],['cor','cor'],['brand_id','marca'],['arquivado_em','arquivamento']]);await audit(supabase,who,'atualizar_tag','tag',a.id,changeAuditDetails(changes));return toolText({tag:{id:String(data.id),link:APP_URL+'/#tasks',nome:data.nome,cor:data.cor,marca_id:data.brand_id,arquivada:!!data.arquivado_em,historico:await fullAuditHistory(supabase,'tag',a.id)}})})
  server.registerTool('marcar_tag',{description:'Marca tag em tarefa ou campanha.',inputSchema:z.object({tag:z.string(),tipo:z.enum(['tarefa','campanha']),registro_id:z.string()})},async(a:any)=>{const who=await actor(supabase),tag=await fullTag(supabase,a.tag),obj={id:String(tag.id),nome:tag.nome,cor:tag.cor||null};if(a.tipo==='tarefa'){const ts=await readState(supabase,TASKS_KEY),t=findTask(ts,a.registro_id),before=structuredClone(t.tags||[]);t.tags=Array.isArray(t.tags)?t.tags:[];if(!t.tags.some((x:any)=>String(x?.id||x)===String(tag.id)))t.tags.push(obj);const changes=[{campo:'tags',antes:before,depois:structuredClone(t.tags)}];prependEntityChanges(t,who,changes);await writeTasks(supabase,ts);await audit(supabase,who,'marcar_tag','tarefa',t.id,changeAuditDetails(changes,{tag_id:tag.id}));return toolText({tarefa:publicTask(t)})}const cs=await fullCampaigns(supabase),c=fullCampaign(cs,a.registro_id),before=structuredClone(c.tags||[]);c.tags=Array.isArray(c.tags)?c.tags:[];if(!c.tags.some((x:any)=>String(x?.id||x)===String(tag.id)))c.tags.push(obj);const changes=[{campo:'tags',antes:before,depois:structuredClone(c.tags)}];prependEntityChanges(c,who,changes);await fullSaveCampaigns(supabase,cs);await audit(supabase,who,'marcar_tag','campanha',c.id,changeAuditDetails(changes,{tag_id:tag.id}));return toolText({campanha:fullPublicCampaign(c)})})
  server.registerTool('desmarcar_tag',{description:'Desmarca tag sem excluir a tag.',inputSchema:z.object({tag:z.string(),tipo:z.enum(['tarefa','campanha']),registro_id:z.string()})},async(a:any)=>{const who=await actor(supabase),tag=await fullTag(supabase,a.tag),keep=(x:any)=>String(x?.id||x)!==String(tag.id)&&norm(x?.nome||x)!==norm(tag.nome);if(a.tipo==='tarefa'){const ts=await readState(supabase,TASKS_KEY),t=findTask(ts,a.registro_id),before=structuredClone(t.tags||[]);t.tags=(t.tags||[]).filter(keep);const changes=[{campo:'tags',antes:before,depois:structuredClone(t.tags)}];prependEntityChanges(t,who,changes);await writeTasks(supabase,ts);await audit(supabase,who,'desmarcar_tag','tarefa',t.id,changeAuditDetails(changes,{tag_id:tag.id}));return toolText({tarefa:publicTask(t)})}const cs=await fullCampaigns(supabase),c=fullCampaign(cs,a.registro_id),before=structuredClone(c.tags||[]);c.tags=(c.tags||[]).filter(keep);const changes=[{campo:'tags',antes:before,depois:structuredClone(c.tags)}];prependEntityChanges(c,who,changes);await fullSaveCampaigns(supabase,cs);await audit(supabase,who,'desmarcar_tag','campanha',c.id,changeAuditDetails(changes,{tag_id:tag.id}));return toolText({campanha:fullPublicCampaign(c)})})
  ...
  withSupabase({ auth: 'user' }, async (req: Request, { supabase }: any) => {
    ...
    const handler = createMcpHandler(() => {
      const server = new McpServer({
        ...
        websiteUrl: APP_URL,
        icons: [{ src: MCP_ICON_DATA_URI, mimeType: 'image/png', sizes: ['48x48','96x96','192x192','512x512'] }],
      })
...
Deno.serve(async (req: Request) => {
  ...
  if (url.pathname.endsWith('/icon.png')) {
    ...
    return new Response(bytes, { status: 200, headers: {
      ...
      'X-AllianceOS-Brand': MCP_BRAND_VERSION,
    }})
  }
