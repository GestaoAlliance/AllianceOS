...
Deno.serve(async (req: Request) => {
  ...
  if (url.pathname.endsWith('/icon.svg') || url.pathname.endsWith('/icon.png')) {
    return new Response(MCP_ICON_SVG, { status: 200, headers: {
