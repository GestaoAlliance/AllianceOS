...
export default async function handler(req,res){
  ...
  }catch(e){console.error('[agenda proxy]',e);if(e?.status===401||e?.status===403)return authError(res,e);return send(res,502,JSON.stringify({erro:String(e.message||e).slice(0,250)}))}
}
