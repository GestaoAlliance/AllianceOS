...
const { generateSocialPreview } = require('./social-preview');
...
async function main() {
  ...
  await generateSocialPreview(path.join(out, 'allianceos-whatsapp-preview-v5.png'));
