...
const SOCIAL_PREVIEW_SOURCE = path.join(__dirname, 'assets', 'allianceos-whatsapp-preview-v2.jpg');
...
async function main() {
  ...
  await sharp(SOCIAL_PREVIEW_SOURCE)
    ...
    .toFile(path.join(out, 'allianceos-whatsapp-preview-hq.png'));
