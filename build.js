...
const SOCIAL_PREVIEW_IMAGE = path.join(__dirname, 'assets', 'allianceos-whatsapp-preview-monochrome.jpg');
...
async function main() {
  ...
  fs.copyFileSync(SOCIAL_PREVIEW_IMAGE, path.join(out, 'allianceos-whatsapp-preview-monochrome.jpg'));
