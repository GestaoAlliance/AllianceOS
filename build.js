...
const SOCIAL_PREVIEW_IMAGE = path.join(__dirname, 'assets', 'allianceos-whatsapp-preview-v2.jpg');
...
async function main() {
  ...
  fs.copyFileSync(SOCIAL_PREVIEW_IMAGE, path.join(out, 'allianceos-whatsapp-preview-v2.jpg'));
